...
Instead of deleting the existing database and starting again, I migrated the existing structure and preserved the existing book records.

The migration involved:

Adding category_id
Creating the new table structure
Transferring existing records using INSERT ... SELECT
Replacing the old table
Renaming the migrated table
